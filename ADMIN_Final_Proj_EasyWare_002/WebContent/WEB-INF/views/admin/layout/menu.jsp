...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%><!-- JSTL 선언 -->
	...
	<ul class="nav nav-pills nav-stacked list-group">
		<li><a href="#" data-toggle="collapse" data-target="#list1"
			...
			class="list-group-item active collapsed"> 인적 자원 관리 </a>
	...
	<ul class="nav nav-pills nav-stacked list-group">
		<li><a href="#" data-toggle="collapse" data-target="#list2"
			...
			class="list-group-item active collapsed"> 보안 관리 </a>
			<ul id="list2" class="nav collapse" aria-expanded="false">       
				<li><a href="<c:url value='/logging/connect_list' />" class="list-group-item"> 로그인 로그 조회 </a></li>
