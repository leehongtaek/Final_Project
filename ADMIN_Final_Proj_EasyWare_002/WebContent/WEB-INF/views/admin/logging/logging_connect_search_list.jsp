...
<div align="center">
	<ul class="pagination">
		<li>  
		<a href="<c:url value='/logging/connect_search_list?currentpage=${pagingData.prev_pageno}&start_time=${svo.start_time}&end_time=${svo.end_time}&log_type=${vo.log_type}&mem_id=${vo.mem_id}'/>">«</a></li>
		<c:forEach var="iter" begin="${pagingData.page_sno}" end="${pagingData.page_eno}">   
		<li id="pagination">                
		<a href="<c:url value='/logging/connect_search_list?currentpage=${iter}&start_time=${svo.start_time}&end_time=${svo.end_time}&log_type=${vo.log_type}&mem_id=${vo.mem_id}'/>"><b>${iter}</b></a></li>
		</c:forEach>  
		<li><a href="<c:url value='/logging/connect_search_list?currentpage=${pagingData.next_pageno}&start_time=${svo.start_time}&end_time=${svo.end_time}&log_type=${vo.log_type}&mem_id=${vo.mem_id}'/>">»</a></li>
		</ul>
