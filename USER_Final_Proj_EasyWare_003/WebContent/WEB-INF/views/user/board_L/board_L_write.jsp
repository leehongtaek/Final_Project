...
<script type="text/javascript">
	function board_alarm() {
		alram_Send('notice/n/n');
	}
</script>
<style>
.dot {
...
<div class="panel panel-warning">
	<div class="panel-heading">
		<h2>
			<span class="lnr lnr-pencil"></span> 게시글 작성
		</h2>
		<br />
	</div>
</div>
...
<form method="post" onsubmit="board_alarm()"
	action='<c:url value="/board/insert"/>'>
	<input type="hidden" value="${board_code}" name="board_code" id="board_code"/>
	<div class="content">
		<!-- start name email -->
		<div class="j-row">
			<!-- start subject -->
 ...
 -->
	...
	<div class="footer">
		...
		<button type="button" class="btn btn-warning" data-toggle="tooltip"
			data-placement="top"
			onclick="location='board_L_list?board_code=${board_code}'"
			title="작성을 취소하고 게시판 목록으로 돌아갑니다.">돌아가기</button>
	</div>
...
<!-- 다음 지도 API -->
<script type="text/javascript"
	src="//apis.daum.net/maps/maps3.js?apikey=bcc3446a29df6a27c794d98bb532b75c"></script>
<script type="text/javascript"
	src="//apis.daum.net/maps/maps3.js?apikey=bcc3446a29df6a27c794d98bb532b75c&libraries=services"></script>
<script type="text/javascript"
	src="//apis.daum.net/maps/maps3.js?apikey=bcc3446a29df6a27c794d98bb532b75c&libraries=services,clusterer"></script>

<script>
	var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
	mapOption = {
		center : new daum.maps.LatLng(37.40179, 127.10679), // 지도의 중심좌표
		level : 3
	// 지도의 확대 레벨
	};
